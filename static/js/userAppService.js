...
$(document).ready(function(){
    orgEdgexFoundry.userAppService.initServices();
    orgEdgexFoundry.userAppService.initPipeline();
    orgEdgexFoundry.userAppService.dragDlg();
    orgEdgexFoundry.userAppService.loadAllDeviceAndValueDescriptor();
});

orgEdgexFoundry.userAppService = (function () {
    "use strict";
    ...
    UserAppService.prototype.clickParamButton = function (e) {
    ...
    UserAppService.prototype.saveParams = function(){
    ...
    UserAppService.prototype.initServices = function initServices() {
        $.ajax({
    ...
    UserAppService.prototype.changeServiceSelect = function(){
    ...
    UserAppService.prototype.initPipeline = function initPipeline() {
    ...
    UserAppService.prototype.dragDlg = function (){
        var moveDivId;
        ...
        $(".helper-dialog-wrapper").bind("mouseup",function() {
            ...
            var params;
                if(leftContainer.find("div[id='"+moveDivId+"']").length == 0){
                    ...
                    var button ;
                    if(params != null){
                        button ='<button type="button" onclick="orgEdgexFoundry.userAppService.clickParamButton(this)" class="btn btn-success appservice_paramButton" value="" id="button_'+moveDivId+'" placeholder="Set Params" onmouseup="event.cancelBubble = true" onmousedown="event.cancelBubble = true">' +
    ...
    UserAppService.prototype.deployToConsul = function(){
        ...
        $.ajax({
            url: '/api/v1/user/config/appservice/'+appService.servicekey,
            type: 'POST',
